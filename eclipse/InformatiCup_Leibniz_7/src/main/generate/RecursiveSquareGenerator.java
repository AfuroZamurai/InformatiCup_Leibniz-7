...
public class RecursiveSquareGenerator implements IGenerator {
	...
	public String getModuleDescription() {
		return "Blockrekursion: \n\n" + "Dieser Generator generiert Bilder aus verschiedenfarbigen Quadraten"
				...
				+ "erkannten Bildes ein Startbild f�r die zweite Phase zu finden. In dieser Phase "
				+ "werden dann zuf�llig neue Bl�cke hinzugef�gt. Durch ein greedy Verfahren konvergieren "
