...
public class CheckerGenerator implements IGenerator {
	...
	public String getModuleDescription() {
		return "Checker Search:\n\nDas Bild wird in rechteckige Pixelgruppen aufgeteilt. "
				+ "Die Gruppen werden einzeln im Bild schwarz gefärbt. "
				+ "Steigt dadurch die Konfidenz des Bildes, wird die Gruppe im Ausgabebild auf schwarz gesetzt. "
				+ "Sinkt oder bleibt die Konfidenz gleich, wird sie auf weiß gesetzt. "
				+ "Das wird mit allen Gruppen gemacht. So entsteht ein Ausgabebild aus schwarzen und weißen Rechtecken. "
				+ "Die Katenlänge eines Rechtecks gibt der Parameter Filtergröße an.\n\n";
	}
